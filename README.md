...
Once the `conda-forge` channel has been enabled, `winreg` can be installed with:

```
conda install winreg
```

It is possible to list all of the versions of `winreg` available on your platform with:
